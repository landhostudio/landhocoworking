    ...
    <div class="board<?php if (get_sub_field('board__layout') == 'one'): ?> board--one<?php elseif (get_sub_field('board__layout') == 'two'): ?> board--two<?php elseif (get_sub_field('board__layout') == 'three'): ?> board--three<?php elseif (get_sub_field('board__layout') == 'four'): ?> board--four<?php endif; ?>">
      <div class="container">
        <div class="layout__row">
          ...
          <article class="card card__1 card--large layout__xs__12 layout__sm__6 layout__md__6 layout__lg__6">
          ...
          <div class="card__group layout__xs__12 layout__sm__6 layout__md__6 layout__lg__6">
            <div class="layout__row">

              <article class="card card__2 card--medium layout__xs__12 layout__sm__12 layout__md__12 layout__lg__12">
              ...
              <article class="card card__3 card--small<?php if (get_sub_field('board__small__1__type') == 'image'): ?> card--image<?php elseif (get_sub_field('board__small__1__type') == 'video'): ?> card--video<?php elseif (get_sub_field('board__small__1__type') == 'text'): ?> card--text<?php endif; ?> layout__xs__6 layout__sm__6 layout__md__6 layout__lg__6">
              ...
              <article class="card card__4 card--small<?php if (get_sub_field('board__small__2__type') == 'image'): ?> card--image<?php elseif (get_sub_field('board__small__2__type') == 'video'): ?> card--video<?php elseif (get_sub_field('board__small__2__type') == 'text'): ?> card--text<?php endif; ?> layout__xs__6 layout__sm__6 layout__md__6 layout__lg__6">
